...
from third_party.sdf_vae.models.conv_pointnet import ConvPointnet
from third_party.sdf_vae.models.sdf_decoder import SdfDecoder
...
class SdfModel(pl.LightningModule):
    ...
    def __init__(self, specs):
        ...
        self.pointnet = ConvPointnet(c_dim=self.latent_dim, hidden_dim=self.pn_hidden, plane_resolution=128)
